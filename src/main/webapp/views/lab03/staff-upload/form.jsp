...
<body>
<form action="${pageContext.request.contextPath}/staff-upload" enctype="multipart/form-data" method="post">
    Họ và tên: <input type="text" name="name"><br>
    Hình ảnh: <input type="file" name="photo" placeholder="Chọn tệp"><br>
